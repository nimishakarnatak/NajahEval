...
export const NAJAH_SCHEMA_STATEMENTS = [
  ...
  `
    CREATE TABLE IF NOT EXISTS episodes (
      ...
      subsequent_context TEXT NOT NULL DEFAULT '',
  ...
  `
    CREATE TABLE IF NOT EXISTS rubric_annotations (
      ...
      participant_behaviours_json TEXT NOT NULL DEFAULT '{}',
      participant_behaviour_evidence_turns_json TEXT NOT NULL DEFAULT '{}',
      participant_behaviour_other TEXT NOT NULL DEFAULT '',
      participant_reactions_json TEXT NOT NULL DEFAULT '{}',
      participant_reaction_evidence_turns_json TEXT NOT NULL DEFAULT '{}',
      participant_reaction_other TEXT NOT NULL DEFAULT '',
...
export const NAJAH_SCHEMA_MIGRATION_STATEMENTS = [
  ...
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS participant_gender TEXT NOT NULL DEFAULT 'unknown'",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS activity_group TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS sampling_weight DOUBLE PRECISION",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS participant_sampling_probability DOUBLE PRECISION",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS focal_episode_selection_probability DOUBLE PRECISION",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS combined_episode_inclusion_probability DOUBLE PRECISION",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS activity_group_validation_status TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE episodes ADD COLUMN IF NOT EXISTS subsequent_context TEXT NOT NULL DEFAULT ''",
  ...
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS critical_evidence_turns_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_responses_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_response_other TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_behaviours_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_behaviour_evidence_turns_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_behaviour_other TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_reactions_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_reaction_evidence_turns_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS participant_reaction_other TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS module_episode_ending TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS stopping_factors_json TEXT NOT NULL DEFAULT '{}'",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS stopping_factors_evidence_turns TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS stopping_factors_explanation TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS gender_context_handling TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS most_useful_thing TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE rubric_annotations ADD COLUMN IF NOT EXISTS suggested_improvement TEXT NOT NULL DEFAULT ''",
  ...
  "CREATE INDEX IF NOT EXISTS idx_episodes_activity_group ON episodes(activity_group)",
  `
    DO $$
    DECLARE
