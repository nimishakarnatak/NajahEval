...
export async function GET(request: Request) {
  ...
  const query = db.prepare(`
    SELECT
      ...
      e.activity_group_validation_status AS "activityGroupValidationStatus",
      ...
      ra.stopping_factors_evidence_turns AS "stoppingFactorsEvidenceTurns",
      ra.stopping_factors_explanation AS "stoppingFactorsExplanation",
